        ...
        <form id="addsite" class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="tname" autocomplete="off" placeholder="填写项目名称"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="tcontent" autocomplete="off" placeholder="填写项目内容"
                           class="layui-input" lay-verify="required">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="ttime" autocomplete="off" placeholder="填写项目时间"
                           class="layui-input" lay-verify="required">
                </div>
            </div>
                ...
                <div class="layui-input-block">
                    <select name="trid.rid" class="layui-input">
                        ...
                        <c:forEach items="${listTrid}" var="resume">
                            <option value="${resume.rid}" class="layui-input" >${resume.rjobs}</option>
                        </c:forEach>
                    </select>
    ...
    layui.use(['laydate','form', 'layer'], function() {
        ...
        form.on('submit(add)', function(data) {
            layer.alert("增加成功", {icon: 6}, function() {
                ...
                $.ajax({
                    type:"POST",
                    url:"${pageContext.request.contextPath}/through/addThrough",
                    dataType:"text",
                    data:datas,
