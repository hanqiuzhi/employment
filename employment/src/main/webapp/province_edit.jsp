    ...
    <div class="layui-row">
        <form class="layui-form" id="update" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="pname" autocomplete="off" id="pname"
                           class="layui-input" lay-verify="required" value="${requestScope.province.pname}">
                </div>
            </div>
        ...
        form.on('submit(update)', function(data) {
            ...
            layer.alert("修改成功", {
                ...
                function() {
                    $.ajax({
                        type:"POST",
                        url:"${pageContext.request.contextPath}/province/updateProvince",
                        dataType:"text",
                        data:datas,
                        success:function (data){
                            if(data == 'true'){
